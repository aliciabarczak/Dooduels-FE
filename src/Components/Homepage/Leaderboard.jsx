  ...
  const [users, setUsers] = useState([
        {
          ...
          username: "Doodoo",
          status: "online",
          user_description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque nisl eros, pulvinar facilisis justo mollis, auctor consequat urna. Morbi a bibendum metus.",
        ...
        return (
          <article className="leaderboard-user" key={user.user_id}>
            <li className="leaderboard-list">
              <img className="home-profile-pic" src={user.profile_pic} alt="user profile pic"/>
